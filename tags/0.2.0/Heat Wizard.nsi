...
Section ""
  SetOutPath $INSTDIR
  File "${name}.exe"
  File "Heat Wizard Release Notes 0.2.0.txt"
  ...
  CreateShortCut  "$SMPROGRAMS\${name}\Heat Wizard Release Notes 0.2.0.lnk" "$INSTDIR\Heat Wizard Release Notes 0.2.0.txt"
...
Section "Uninstall"
  ...
  Delete   "$SMPROGRAMS\${name}\Heat Wizard Release Notes 0.2.0.lnk"
  RMDir    "$SMPROGRAMS\${name}"
  Delete   "$INSTDIR\${name}.exe"
  Delete   "$INSTDIR\Heat Wizard Release Notes 0.2.0.txt"
